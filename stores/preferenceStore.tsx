...
const dictionaries = {
  vi: {
    ...
    loginSubtitle: "Đăng nhập ngay để kiểm soát dinh dưỡng của bạn.",
    ...
    exploreDescription: "Tìm kiếm món ăn của bạn.",
    ...
    carbsShort: "Carb",
    fatShort: "Béo",
    createMeal: "Tạo bữa ăn",
    createMealHint:
      "Kiểm tra món đã chọn, chỉnh khẩu phần và thông tin bữa ăn.",
    mealType: "Loại bữa",
    breakfast: "Bữa sáng",
    lunch: "Bữa trưa",
    dinner: "Bữa tối",
    snack: "Bữa phụ",
    eatenAt: "Thời gian ăn",
    now: "Bây giờ",
    date: "Ngày",
    time: "Giờ",
    note: "Ghi chú",
    notePlaceholder: "Ví dụ: ít dầu, không đường...",
    mealTotals: "Tổng dinh dưỡng",
    addedFoods: "Món đã thêm",
    addMoreFoods: "Thêm món",
    gramInput: "Khẩu phần (g)",
    gramsShort: "g",
    emptyMealDraftTitle: "Chưa có món nào",
    emptyMealDraftDescription: "Quay lại tìm món để thêm thực phẩm vào bữa ăn.",
    saveMeal: "Lưu bữa ăn",
    saveMealComingNext: "Phần lưu bữa ăn sẽ nối API ở task 04-06.",
    invalidMealDraft: "Hãy thêm ít nhất một món hợp lệ trước khi lưu.",
    mealSaved: "Đã lưu bữa ăn",
    savedMealHint: "Bữa ăn đã được ghi nhận. Bạn có thể quay về trang chủ hoặc tạo bữa mới.",
    backHome: "Về trang chủ",
    createAnotherMeal: "Tạo bữa mới",
    mealSaveFailed: "Không lưu được bữa ăn",
  ...
  en: {
    ...
    loginSubtitle: "Sign in now to take control of your nutrition.",
    loginButton: "Sign in",
    ...
    exploreDescription: "Search for your food.",
    ...
    createMealHint: "Review selected foods, adjust portions, and meal details.",
    mealType: "Meal type",
    breakfast: "Breakfast",
    lunch: "Lunch",
    dinner: "Dinner",
    ...
    time: "Time",
    note: "Note",
    notePlaceholder: "Example: less oil, no sugar...",
    mealTotals: "Nutrition totals",
    addedFoods: "Added foods",
    addMoreFoods: "Add foods",
    gramInput: "Serving (g)",
    gramsShort: "g",
    emptyMealDraftTitle: "No foods yet",
    emptyMealDraftDescription:
      "Go back to food search to add items to this meal.",
    saveMeal: "Save meal",
    saveMealComingNext:
      "Meal saving will be connected to the API in task 04-06.",
    invalidMealDraft: "Add at least one valid food before saving.",
    mealSaved: "Meal saved",
    savedMealHint:
      "The meal has been recorded. You can go home or create another meal.",
    backHome: "Back home",
    createAnotherMeal: "Create another",
    mealSaveFailed: "Could not save meal",
